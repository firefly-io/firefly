	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.InstallV1alpha1().Karmadas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.InstallV1alpha1().Karmadas(namespace).Watch(context.TODO(), options)
			},
		},
		&installv1alpha1.Karmada{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *karmadaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&installv1alpha1.Karmada{}, f.defaultInformer)
}
