...
type FakeFoos struct {
	Fake *FakeToolkitV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "toolkit.firefly.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "toolkit.firefly.io", Version: "v1alpha1", Kind: "Foo"}
