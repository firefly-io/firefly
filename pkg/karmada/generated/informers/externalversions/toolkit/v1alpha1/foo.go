...
import (
	...
	v1alpha1 "github.com/firefly-io/firefly/pkg/karmada/generated/listers/toolkit/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ToolkitV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ToolkitV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&toolkitv1alpha1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&toolkitv1alpha1.Foo{}, f.defaultInformer)
}
